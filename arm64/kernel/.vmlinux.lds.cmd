cmd_arch/arm64/kernel/vmlinux.lds := /home/student/buildroot/output/host/bin/aarch64-buildroot-linux-gnu-gcc -E -Wp,-MMD,arch/arm64/kernel/.vmlinux.lds.d -nostdinc -isystem /home/student/buildroot/output/host/lib/gcc/aarch64-buildroot-linux-gnu/12.3.0/include -I./arch/arm64/include -I./arch/arm64/include/generated  -I./include -I./arch/arm64/include/uapi -I./arch/arm64/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -D__KERNEL__ -mlittle-endian -DCC_USING_PATCHABLE_FUNCTION_ENTRY -DKASAN_SHADOW_SCALE_SHIFT=3 -fmacro-prefix-map=./=   -P -Uarm64 -D__ASSEMBLY__ -DLINKER_SCRIPT -o arch/arm64/kernel/vmlinux.lds arch/arm64/kernel/vmlinux.lds.S
